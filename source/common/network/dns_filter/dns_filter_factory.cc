...
DnsFilterFactory_guard DnsFilterFactory::dnsfilterfactory_;
...
bool DnsFilterFactory::processRequest(const std::string& url, Envoy::Network::DnsLookupFamily family, Envoy::Network::DnsResolver::ResolveCb callback, OUT std::string &filterName)
{
...
bool DnsFilterFactory::processRequestInternal(const std::string& url, Envoy::Network::DnsLookupFamily family, Envoy::Network::DnsResolver::ResolveCb callback, OUT std::string &filterName)
{
